 ...
 *
 * U8TO16_LE(x) Read a little endian unsigned 32-bit int U8TO32_LE(x) Read a
 * little endian unsigned 32-bit int U8TO28_LE(x) Read a little endian unsigned
 * 32-bit int ROTL32(x,r) Rotate x left by r bits ROTL64(x,r) Rotate x left by
