...
compatibility.) C<SVt_NV> can hold any of those or a double.  C<SVt_PV> can
only hold C<undef> or a string.  C<SVt_PVIV> is a superset of C<SVt_PV> and
C<SVt_IV>.  C<SVt_PVNV> is similar.  C<SVt_PVMG> can hold anything C<SVt_PVNV>
...
typedef enum {
        ...
        SVt_PVFM,       /* 14 */
        SVt_PVIO,       /* 15 */
                        /* 16-31: Unused, though one should be reserved
...
unencombered by things like COW.  Using C<SV_CHECK_THINKFIRST> or
...
have a real C<PV> that is unencombered by things like COW.  Think
