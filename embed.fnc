...
Cp	|U8*	|uvoffuni_to_utf8_flags_msgs|NN U8 *d|const UV input_uv	    \
				|UV flags|NULLOK HV** msgs
...
#if defined(PERL_IN_SCOPE_C)
Sd	|SV*	|save_scalar_at	|NN SV **sptr|const U32 flags
#endif
...
CpT	|Malloc_t	|mem_log_realloc	|const UV n|const UV typesize|NN const char *type_name|const Malloc_t oldalloc|Malloc_t newalloc|NN const char *filename|const int linenumber|NN const char *funcname
